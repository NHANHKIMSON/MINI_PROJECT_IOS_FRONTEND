    ...
    var body: some View {
        List {
            ...
            HStack {
                ...
                .alert("New Category", isPresented: $showingAlert) {
                    TextField("New Category", text: $name)
                    Button("OK") {
//                        addNewCategory(name: "love", icon: "heart")
                        
                    }
                } message: {
                    Text("Enter category you want to create")
                }
...
#Preview {
    SelectCategoriesView(category: .constant(""), categoryId: .constant(1))
    //    AddProductView(
}
